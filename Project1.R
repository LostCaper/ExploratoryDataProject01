...
setwd("C:/Users/gmacmaster/Documents/R_Project/ExploratoryDataAnalysis")

#Step 3: Read in the file 
dat<-read.table("C:/Users/gmacmaster/Documents/R_Project/ExploratoryDataAnalysis/household_power_consumption.txt",header=TRUE, sep=";")

#Step 4: Convert Date
dat$Date<-as.Date(dat$Date,format="%d/%m/%Y")


#Step 4: Select only 1/2/2007 and 2/2/2007
